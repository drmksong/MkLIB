...
//     // MkRects cols(4);
//     cols[0].SetOrigin(MkPoint(20, 20));
//     cols[0].SetCenter(MkPoint(30, 30));
//     cols[1].SetOrigin(MkPoint(60, 20));
//     cols[1].SetCenter(MkPoint(70, 30));
//     cols[2].SetOrigin(MkPoint(20, 60));
//     cols[2].SetCenter(MkPoint(30, 70));
//     cols[3].SetOrigin(MkPoint(60, 60));
//     cols[3].SetCenter(MkPoint(70, 70));
